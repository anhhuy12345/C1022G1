...
<div class="mt-2 sticky row" style="background: #ecf4f4;margin-top: -0.5rem!important;">
    <nav class="navbar navbar-light">
        <div class="container-fluid" style="color: coral">
            ...
            <a class="navbar-brand text-warning click col-l-2" href="" >Văn Học Trong Nước</a>
            <a class="navbar-brand text-warning click col-l-2" href="">Văn Học Nước Ngoài</a>
            <a class="navbar-brand text-warning click col-l-2" href="" >Truyện Dài</a>
            <a class="navbar-brand text-warning click col-l-2" href="" >Thể Loại Khác</a>
